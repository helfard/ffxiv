...
const AREA = {
    ...
    // 漆黒エリア
    'レイクランド': { w: 41.9, h: 41.9, src: 'lakeland.jpg' },
    'コルシア島': { w: 41.9, h: 41.9, src: 'kholusia.jpg' },
    'アム・アレーン': { w: 41.9, h: 41.9, src: 'amharaeng.jpg' },
    'イル・メグ': { w: 41.9, h: 41.9, src: '' },
    'ラケティカ大森林': { w: 41.9, h: 41.9, src: '' },
    'テンペスト': { w: 41.9, h: 41.9, src: '' },
    // 暁月エリア
