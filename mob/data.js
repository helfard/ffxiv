...
const MONSTER = {
    ...
    '黄金': {
        ...
        'ブロークン・タレット': {
            area: 'ヘリテージファウンド', x: 15.0, y: 5.9, // Xでよりエーテライトに近いポイントを教えてもらったので座標変更
        },
        'ボルトハウンド': {
...
const SET = {
    ...
    '漆黒': {
        ...
        '上級': [
            ...
            ['グルグヌー', 'スイミングクラブ', 'フロア・マンドリル', 'ヤテベオ', 'フレイム・ゾヌール'], // Garuda鯖のMeran Peranさんからの情報提供による
            ...
            ['ドワーヴン・オートマトン', 'テンペストスワロー', 'ホワイト・グレムリン', 'プーカ', 'サンドモール'], // Garuda鯖のMeran Peranさんからの情報提供による
    ...
    '暁月': {
        ...
        '初級': [
            ['カリブー', 'カチャパ', 'マウンテンチキン', 'チャムロッシュ', 'エブラーナベアー'],  // Garuda鯖のMeran Peranさんからの情報提供による
        ...
        '中級': [
            ['オートマチック・アヴェンジャー', 'ダウンフォール・アラーム', 'スウィーパー', 'スクレーパー', 'ブンジャンガ'], // Garuda鯖のMeran Peranさんからの情報提供による
        ...
        '上級': [
            ...
            ['オートマチック・マグナローダー', 'バブーン', 'スクレーパー', 'イグドリア', 'ドリフティング・イーア'], // Tiamat鯖のLeno Arulaqさんからの情報提供による
