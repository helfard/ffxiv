...
const WORDS = {
    ...
    'add to dock': {
        ...
        'en': 'Click a submersible to add to the Dock.',
        'zh-TW': 'Click a submersible to add to the Dock.',
        'zh-CH': 'Click a submersible to add to the Dock.',
        'ko': 'Click a submersible to add to the Dock.',
        'fr': '',
        'de': '',
    },
    'remove from dock': {
        'ja': '一覧をクリックすると候補一覧に戻します。',
        'en': 'Click a submersible to remove from the Dock.',
        'zh-TW': 'Click a submersible to remove from the Dock.',
        'zh-CH': 'Click a submersible to remove from the Dock.',
        'ko': 'Click a submersible to remove from the Dock.',
        'fr': '',
        'de': '',
    },
    'copy submersibles': {
