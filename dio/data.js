...
BONUS[96] = [0, 61, 82, 46, 72, 55];
BONUS[97] = [0, 61, 84, 46, 74, 55];
BONUS[98] = [0, 63, 84, 48, 76, 57];
BONUS[99] = [0, 63, 88, 48, 78, 58];
BONUS[100] = [0, 65, 90, 50, 80, 60];
BONUS[101] = [0, 66, 92, 52, 82, 60];
BONUS[102] = [0, 67, 92, 54, 84, 60];
BONUS[103] = [0, 68, 94, 56, 86, 62];
BONUS[104] = [0, 68, 96, 58, 88, 64];
BONUS[105] = [0, 70, 100, 60, 90, 65];
BONUS[106] = [0, 72, 100, 61, 91, 66];
BONUS[107] = [0, 72, 100, 63, 92, 67];
BONUS[108] = [0, 73, 101, 63, 93, 69];
BONUS[109] = [0, 73, 102, 65, 94, 69];
BONUS[110] = [0, 75, 105, 65, 95, 70];
BONUS[111] = [0, 76, 106, 66, 96, 70];
BONUS[112] = [0, 76, 107, 66, 97, 70];
BONUS[113] = [0, 78, 107, 68, 98, 72];
BONUS[114] = [0, 78, 109, 68, 99, 73];
BONUS[115] = [0, 80, 110, 70, 100, 75];
BONUS[116] = [0, 81, 110, 71, 101, 75];
BONUS[117] = [0, 82, 111, 72, 102, 75];
BONUS[118] = [0, 83, 112, 73, 103, 77];
BONUS[119] = [0, 83, 113, 74, 104, 79];
BONUS[120] = [0, 85, 115, 75, 105, 80];
BONUS[121] = [0, 87, 115, 76, 106, 81];
BONUS[122] = [0, 87, 115, 78, 107, 82];
BONUS[123] = [0, 88, 116, 78, 108, 84];
BONUS[124] = [0, 88, 117, 80, 109, 84];
BONUS[125] = [0, 90, 120, 80, 110, 85];
BONUS[126] = [0, 91, 121, 81, 111, 85];
BONUS[127] = [0, 91, 122, 81, 112, 85];
BONUS[128] = [0, 93, 122, 83, 113, 87];
BONUS[129] = [0, 93, 124, 83, 114, 88];
BONUS[130] = [0, 95, 125, 85, 115, 90];
const DEKIAI = {
